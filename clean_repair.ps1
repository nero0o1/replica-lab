...
Set-Content -Path j:\replica_lab\src\Core\RosettaStone_Clean.ps1 -Value $rosetta -Encoding UTF8
Set-Content -Path j:\replica_lab\src\Drivers\DriverV3_Clean.ps1 -Value $driver -Encoding UTF8
Write-Host "CLEAN REPAIR DONE"
