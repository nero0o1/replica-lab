...
Set-Content -Path j:\replica_lab\src\Core\RosettaStone.ps1 -Value $rosetta -Encoding UTF8
Set-Content -Path j:\replica_lab\src\Drivers\DriverV3.ps1 -Value $driver -Encoding UTF8
Write-Host "DONE"
